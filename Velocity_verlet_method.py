...
# NOTE: magnetic force cannot be included because update eqn for velocites involves accelaration at two different times
...
for  i in range(timesteps):
    ...
    temp_acc = [[0 for i in range(3)]for j in range(num)]
    for part in range(num):
        ...
        for cord in range(3):
            temp_acc[part][cord] = (systm[part].charge/systm[part].mass)*E[cord] + GF[cord]   #no mag force since it is velocity dependent


    for par in range(num):
        for coord in range(3):
            systm[par].pos[coord] = systm[par].pos[coord] + (systm[par].vel[coord]*timeres) + ((timeres**2)*systm[par].acc[coord]/2)
    ...
    for part1 in range(num):
        ...
        for cord1 in range(3):
            systm[part1].acc[cord1] = (systm[part1].charge/systm[part1].mass)*E[cord1] + GF[cord1]
